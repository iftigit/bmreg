	 ...
	 public String insertEmpRegistrationInfo(String registrationId,
	    ...
	    {	     
				...
				for (int i = 0; i < trainingList.size(); i++)
				{
					...
					trainingName[i] 	=  _trainDTO.getTrainingName();
					trainingFrom[i]     =  _trainDTO.getFromWhere();
					trainingDuration[i] =  _trainDTO.getDuration();
					trainingDesc[i]     =  _trainDTO.getDescription();
				}
			    ...
			    try
				  {
					...
					System.out.println("Procedure Insert_RegInfo Begins");
					 stmt = (OracleCallableStatement) conn.prepareCall(
						...
						stmt.setString(4,  personalDTO.getEmpFatherName());
						stmt.setString(5,  personalDTO.getEmpMotherName());
						...
						stmt.setString(16, personalDTO.getEmpMobileNumber());
						...
						stmt.setString(23, personalDTO.getEmpDisabilityDetail());
						...
						stmt.setString(52, educationDTO.getLastInstitute());
						stmt.setString(53, educationDTO.getPassingYear());						
						
						stmt.setString(54, nomineeDTO.getNomineeName());
						stmt.setString(55, nomineeDTO.getNomineeRelation());
						stmt.setString(56, nomineeDTO.getNomineeFatherName());
						stmt.setString(57, nomineeDTO.getNomineeMotherName());
						stmt.setString(58, nomineeDTO.getNomineePhoneOrMobile());
						stmt.setString(59, nomineeDTO.getContact1Name());						
						stmt.setString(60, nomineeDTO.getContact1Mobile());
						stmt.setString(61, nomineeDTO.getContact1Relation());
						stmt.setString(62, nomineeDTO.getContact2Name());
						stmt.setString(63, nomineeDTO.getContact2Mobile());
						stmt.setString(64, nomineeDTO.getContact2Relation());
						stmt.setString(65, nomineeDTO.getContact3Name());
						stmt.setString(66, nomineeDTO.getContact3Mobile());
						stmt.setString(67, nomineeDTO.getContact3Relation());
