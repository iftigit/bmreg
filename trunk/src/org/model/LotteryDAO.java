	...
	public SelectionParamDTO getSelectionCriteria(int selectionId){
		...
		try
		{
			...
			if (r.next())
			{
				...
				str=CountryDAO.getCountry(Integer.parseInt(r.getString("COUNTRY_PREFERENCE")==null?"0":r.getString("COUNTRY_PREFERENCE")));
				selection.setSelectionId(r.getInt("SELECTION_ID"));
				selection.setAgentId(r.getString("AGENT_ID"));
				...
				selection.setExpireDate(r.getString("EXPIRE_DATE"));
				selection.setStatus(r.getString("STATUS"));
				selection.setLanguages(r.getString("LANGUAGE")==null?"N/A":r.getString("LANGUAGE"));
				selection.setJobPreference(r.getString("JOB_PREFERNCE"));
				selection.setJobExperience(r.getString("JOB_EXPERIENCE"));
				selection.setCountryPreference(str==""?"N/A":str);
