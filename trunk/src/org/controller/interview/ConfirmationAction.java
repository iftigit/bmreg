...
public class ConfirmationAction extends ActionSupport implements ServletContextAware{
	...
	public String execute()
	{
		...
		else if(!loggedInUser.getUserType().equalsIgnoreCase("TTC_CONF_OPERATOR"))
		{
			return "logout";
		}
		...
		GeneralInfoDTO genearaInfo=interviewDAO.getJobSeekerGeneralInfo(jobSeekerNumber);
		...
		if(genearaInfo==null)
		{
			...
			"        Sorry, the given Jobseeker Number has not been selected for the current Interview Process. " +
			"    </td> " +
			"  </tr> " +
			"  <tr> " +
			"    <td>&nbsp;</td> " +
		...
		else
		{
			...
			{
				imageStr="<img src='/BMREG_WEB/resources/images/redAlert.png' border='0' width='150' height='150' />";
				messageStr="You have been selected but your Interview Center is Different.";
			}
			else if(!genearaInfo.getInterviewDate().equalsIgnoreCase(currentDate))
			{
				imageStr="<img src='/BMREG_WEB/resources/images/blueAlert.png' border='0' width='150' height='150' />";
				messageStr="You have been selected but today is not your Interview Date.";
			}
			...
			"  </tr> " +
			"  <tr> " +
			"    <td align='center' style='color:green; font-weight:bold; font-size:25px;vertical-align:middle;text-align:center;' height='60px'> " +
			"		"+messageStr+" " +
			"	</td> " +
			"  </tr> " +
			"  <tr> " +
