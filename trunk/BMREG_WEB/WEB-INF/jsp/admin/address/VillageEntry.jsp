<div class="box" style="margin-top: 100px;width: 700px;text-align: center;">
    ...
    <table width="80%" align="center" border="0">
      ...
      <tr>
       ...
       <tr>
      	<td width="50%" align="left" style="padding-left: 10px;">Mauza/Moholla</td>
      	<td width="50%" align="left" style="padding-left: 10px;" id="PERMANENT_MAUZA_OR_MOHOLLA_TD">
      			<select tabindex="22" name="addressDTO.pUnion" id="PERMANENT_MAUZA_OR_MOHOLLA" class="addressSelectBox" >
      			<option value=""></option>
    			</select>
      	</td>
      </tr>
       ...
       <tr>
      	<td width="50%" align="left" style="padding-left: 10px;">Village</td>
      	<td width="50%" align="left" style="padding-left: 10px;">
      			<input type="text" name="" id="PERMANENT_VILLAGE" value="" style="width: 250px;border: 1px solid grey;" />
      	</td>
      </tr>
      ...
      <tr>
      	...
      	<td width="50%" align="left" style="padding-left: 10px;">
      			<input type="button" name="Submit" value="Submit" onclick="saveAddress('village')" />
      	</td>
      </tr>
