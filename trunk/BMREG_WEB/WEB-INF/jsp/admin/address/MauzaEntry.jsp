<div class="box" style="margin-top: 100px;width: 700px;text-align: center;">
    <h3>Mauza/Moholla Entry Form</h3>
    ...
    <table width="80%" align="center" border="0">
      ...
      <tr>
       ...
       <tr>
      	...
      	<td width="50%" align="left" style="padding-left: 10px;">
		        <input type="text" name="" id="PERMANENT_MAUZA_OR_MOHOLLA" value="" style="width: 250px;border: 1px solid grey;" />
      	</td>
      </tr>
      ...
      <tr>
      	...
      	<td width="50%" align="left" style="padding-left: 10px;">
      			<input type="button" name="Submit" value="Submit" onclick="saveAddress('mauza')" />
      	</td>
      </tr>
      <tr>
