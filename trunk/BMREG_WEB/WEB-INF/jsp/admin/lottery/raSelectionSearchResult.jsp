...
<table width="98%" align="center" border="0" cellpadding="2" cellspacing="0" style="border: 1px solid grey;">     
     <tr bgcolor="#F1F1F1">
        ...
        <td width="5%" align="center" style="padding-left: 10px;" height="25">SL</td>
      	...
      	<td width="10%" align="left" style="padding-left: 10px;" height="25">Gender</td>
      	<td width="20%" align="left" style="padding-left: 10px;" height="25">Job Exp.</td>
      	<td width="5%" align="center" style="padding-left: 10px;" height="25">Status</td>
      ...
      <s:iterator value="selectionList" status="status">
        ...
        <td align="left" style="padding-left: 10px;" height="25"><s:property value="%{#status.count}" /></td>
      	...
      	<td align="left" style="padding-left: 10px;" height="25"><s:property value="gender" /></td>
      	<td align="left" style="padding-left: 10px;" height="25"><s:property value="jobkExperience" /></td>
      	<td align="left" style="padding-left: 10px;" height="25"><s:property value="status" /></td>
