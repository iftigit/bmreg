...
<title>G2G Job Seeker Police Card</title>
...
<div style="width: 1000px;height: 100px;border-right: 1px solid #006219;border-left: 1px solid #006219;">
	...
	<div style="float: left;margin-left: 30px;color: black;margin-top: 15px;text-align: left;">
	 	...
	 	<div style="font-size: 20px;margin-top: 10px;">Job Seeker's Police Card Form (For Malaysia)</div>
	</div>
</div>
</center>
</div>

<form action="downloadPolice.action" method="post">
<center>
...
<tr> 
  ...
  <td align="left" width="60%" style="padding-left: 10px;padding-top: 60px;">
	...
	<input type="submit" class="submitButton" name="Downalod_Card" value="Download Police Card" style="width: 200px;" />
