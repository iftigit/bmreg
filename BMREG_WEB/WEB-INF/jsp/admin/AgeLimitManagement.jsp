...
if(minYear=="" || maxYear=="")
{
 ...
 var loadUrl="saveAgeLimitInfo.action?minYear="+minYear+"&maxYear="+maxYear;
			jQuery("#msgDiv")  
				.html(ajax_load)  
...
<div class="box" style="margin-top: 50px;width: 900px;text-align: center;">
    <h3>Age Limit Management</h3>
    <div style="padding-bottom: 30px;">
    Min Age(Year) : <input type="text" name="minYear" id="minYear" value="<s:property value='minYear' />" style="border: 1px solid gray;"  maxlength="4" />
    &nbsp;&nbsp;&nbsp;&nbsp;
    Max Age(Year) : <input type="text" name="maxYear" id="maxYear"  value="<s:property value='maxYear' />" style="border: 1px solid gray;" maxlength="4"/><br/>

<p style="padding-top: 40px;">     
<input type="button" name="save" value="Save Changes" style="width: 200px;height: 35px;"  onclick="updateAgeLimitInfo()"/>
</p>
</div>
